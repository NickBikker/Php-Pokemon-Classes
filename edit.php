                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="attack1" name="attack_1" value="<?= $data['attack_1'] ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">attack 1 damage</label>
                                <input type="text" class="form-control" id="attack1damage" name="attack_1_damage" value="<?= $data['attack_1_damage'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="attack2" name="attack_2" value="<?= $data['attack_2'] ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">attack 2 damage</label>
                                <input type="text" class="form-control" id="attack2damage" name="attack_2_damage" value="<?= $data['attack_2_damage'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="weaknessmultiplier" name="weakness_multiplier" value="<?= $data['weakness_multiplier'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="resistancevalue" name="resistance_value" value="<?= $data['resistance_value'] ?>">
                            </div>
                        </div>
                    </div>
